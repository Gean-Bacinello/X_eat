...
<div class="d-flex justify-content-center mt-2 mb-2">
  <div class="card shadow rounded border-0 p-4" style="max-width: 900px;">
    <div class="card-body">
      <h3 class="card-title fw-semibold text-primary mb-4">Cadastrar Novo Alimento</h3>
      ...
      <form action="{{ route('alimentos.store') }}" method="POST">
        ...
        <div class="row">
          ...
          <div class="col-md-4 mb-3">
            ...
            <input type="number" class="form-control" id="Energia_kcal" name="Energia_kcal" step="0.01">
          </div>

          <div class="col-md-4 mb-3">
            <label for="Carboidratos_g" class="form-label">Carboidratos (g)</label>
            <input type="number" class="form-control" id="Carboidratos_g" name="Carboidratos_g" step="0.01">
          </div>

          <div class="col-md-4 mb-3">
            <label for="Proteinas_g" class="form-label">Proteínas (g)</label>
            <input type="number" class="form-control" id="Proteinas_g" name="Proteinas_g" step="0.01">
          </div>

          <div class="col-md-4 mb-3">
            <label for="Lipideos_g" class="form-label">Lipídeos (g)</label>
            <input type="number" class="form-control" id="Lipideos_g" name="Lipideos_g" step="0.01">
          </div>

          <div class="col-md-4 mb-3">
            <label for="Colesterol_mg" class="form-label">Colesterol (mg)</label>
            <input type="number" class="form-control" id="Colesterol_mg" name="Colesterol_mg" step="0.01">
          </div>

          <div class="col-md-4 mb-3">
            <label for="Sodio_mg" class="form-label">Sódio (mg)</label>
            <input type="number" class="form-control" id="Sodio_mg" name="Sodio_mg" step="0.01">
          </div>

          <div class="col-md-4 mb-3">
            <label for="Vitamina_B6_mg" class="form-label">Vitamina B6 (mg)</label>
            <input type="number" class="form-control" id="Vitamina_B6_mg" name="Vitamina_B6_mg" step="0.01">
          </div>

          <div class="col-md-4 mb-3">
            <label for="Vitamina_D_ug" class="form-label">Vitamina D (μg)</label>
            <input type="number" class="form-control" id="Vitamina_D_ug" name="Vitamina_D_ug" step="0.01">
          </div>

          <div class="col-md-4 mb-3">
            <label for="Calcio_mg" class="form-label">Cálcio (mg)</label>
            <input type="number" class="form-control" id="Calcio_mg" name="Calcio_mg" step="0.01">
          </div>

          <div class="col-md-4 mb-3">
            <label for="Ferro_mg" class="form-label">Ferro (mg)</label>
            <input type="number" class="form-control" id="Ferro_mg" name="Ferro_mg" step="0.01">
          </div>

          <div class="col-md-4 mb-3">
            <label for="Potassio_mg" class="form-label">Potássio (mg)</label>
            <input type="number" class="form-control" id="Potassio_mg" name="Potassio_mg" step="0.01">
          </div>

          <div class="col-md-4 mb-3">
            <label for="Acido_Folico_ug" class="form-label">Ácido Fólico (μg)</label>
            <input type="number" class="form-control" id="Acido_Folico_ug" name="Acido_Folico_ug" step="0.01">
          </div>

          <div class="col-md-4 mb-3">
            <label for="Gorduras_Saturadas_g" class="form-label">Gorduras Saturadas (g)</label>
            <input type="number" class="form-control" id="Gorduras_Saturadas_g" name="Gorduras_Saturadas_g" step="0.01">
          </div>

          <div class="col-md-4 mb-3">
            <label for="Gorduras_Trans_g" class="form-label">Gorduras Trans (g)</label>
            <input type="number" class="form-control" id="Gorduras_Trans_g" name="Gorduras_Trans_g" step="0.01">
          </div>

          <div class="col-md-4 mb-3">
            <label for="Fibra_Alimentar_g" class="form-label">Fibra Alimentar (g)</label>
            <input type="number" class="form-control" id="Fibra_Alimentar_g" name="Fibra_Alimentar_g" step="0.01">
          </div>
        </div>
